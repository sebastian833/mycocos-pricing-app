...
export default function Packs() {
  ...
  useEffect(() => {
    setLoading(true)
    Promise.all([
      fetch(marcaActual.packsFile).then(r => r.json()).catch(() => []),
      fetch(marcaActual.componentesFile).then(r => r.json()).catch(() => []),
      fetch(marcaActual.packsGanadoresFile).then(r => r.json()).catch(() => []),
